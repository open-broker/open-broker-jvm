...
object Annuity: LoanType {
    ...
    override fun apr(
        ...
        val totalCost: BigDecimal = totalCost(loanAmount, nominalAnnualInterestRate, termFee, termMonths)
    ...
    private tailrec fun effectiveInterestRate(
        ...
        return effectiveInterestRate(loanAmount, monthlyPayment, paymentTerms, newAprEstimation, y1 / loanAmount)
    }
