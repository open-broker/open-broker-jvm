...
class StraightLineAprTest {
    ...
    fun testComputeEffectiveInterestRate() {
        StraightLine.apply {
            ...
            // 9.9%
            assertEquals(0.099, effectiveInterestRate(10_000, 0.05, 20, 24).toDouble(), 0.0001)

            // 28.09%
            assertEquals(0.2809, effectiveInterestRate(200_000, 0.245, 60, 128).toDouble(), 0.0001)

            // 48.71%
            assertEquals(0.4871, effectiveInterestRate(500_000, 0.40, 120, 180).toDouble(), 0.0001)
