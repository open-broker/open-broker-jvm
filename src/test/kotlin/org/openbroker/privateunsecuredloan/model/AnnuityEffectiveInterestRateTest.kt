...
class AnnuityEffectiveInterestRateTest {
    ...
    fun testComputeEffectiveInterestRate() {
        Annuity.apply {
            ...
            // 9.82%
            assertEquals(0.0982, apr(10_000, 0.05, 20, 24).toDouble(), 0.0001)

            // 27.97%
            assertEquals(0.2797, apr(200_000, 0.245, 60, 128).toDouble(), 0.0001)

            // 48.63%
            assertEquals(0.4863, apr(500_000, 0.40, 120, 180).toDouble(), 0.0001)
